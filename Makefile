...
MySym.class: MySym.java
	$(JC) $(FLAGS) -cp $(CP) MySym.java

SymTable.class: SymTable.java MySym.class DuplicateSymException.class WrongArgumentException.class EmptySymTableException.class
